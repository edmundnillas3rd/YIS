...
export default function ({
    ...
    const onSubmit = async (event: SyntheticEvent) => {
        ...
        const response = await fetch(`${import.meta.env.VITE_BASE_URL}/clubs/update-position-info`, {
            method: "PUT",
            credentials: "include",
            headers: {
    ...
    const onDelete = async (event: SyntheticEvent) => {
        const response = await fetch(`${import.meta.env.VITE_BASE_URL}/clubs/${id}/delete-position`, {
            method: "DELETE",
            credentials: "include"
        });
